...
4. Applied "Expand Selection" to capture all items on the page  
5. Configured pagination using the "Next" button  
6. Ran the scraper using ParseHub cloud  
7. Exported the data into CSV format  
